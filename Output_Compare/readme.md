Output Compare is a feature of the timer that allows you to compare the value of the timer counter with a predefined value stored in a register called the Output Compare Register (OCR).  
